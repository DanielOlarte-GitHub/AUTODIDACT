...
$.ajax({
url:"localhost:8080/api/Bike/all",
type:"GET",
datatype:"JSON",
...
$.ajax({
url:"localhost:8080/api/Bike/:"+ide,
type:"GET",
datatype:"JSON",
success:function(respuesta){
vere(respuesta.items)
...
let myData={
    ...
    $.ajax({
        url:"localhost:8080/api/Bike/update",
        type:"PUT",
        data:dataToSend,
...
function Guardar(){
    ...
    console.log(dataToSend);
    $.ajax({
        url:"localhost:8080/api/Bike/save",
        type:"POST",
        data:dataToSend,
        contentType:"application/json",
...
let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"localhost:8080/api/Bike/delete",
        type:"DELETE",
        data:dataToSend,
        contentType:"application/json",
        complete:function(respuesta){
